...
if (selected == "Parkinsons Prediction"):
    ...
    with col4:
        spread1 = st.text_input('fractal_dimension_se')
        
    with col5:
        spread2 = st.text_input('smoothness_worst')
        
    with col1:
        D2 = st.text_input('fractal_dimension_worst')
        
    with col2:
        PPE = st.text_input('concave points_worst')
...
if(selected=='Breast Cancer Prediction'):
    ...
    with col1:
        i1 = st.text_input('compactness_worst')
        
    with col2:
        i2 = st.text_input('symmetry_worst')
        
    with col3:
        i3 = st.text_input('smoothness_mean')
        
    with col4:
        i4 = st.text_input('concavity_mean')
        
    with col5:
        i5 = st.text_input('concavity_se')
    
    with col1:
        i11 = st.text_input('radius_worst')
    ...
    if st.button("Breast Cancer Test Result"):
        breast_cancer_prediction = breast_cancer_model.predict([[i1,i2,i3,i4,i5,i11]])                          
